...
public class SessionDetailActivityTestKeynoteSession {
    ...
    public void setUpModel() {
        ...
        final PresenterFragmentImpl presenter = mActivityRule.getActivity()
                .addPresenterFragment(fr.paug.droidcon2015.R.id.session_detail_frag, fakeModel,
    ...
    public void sessionTitle_ShowsCorrectTitle() {
        onView(ViewMatchers.withId(fr.paug.droidcon2015.R.id.session_title)).check(matches(
    ...
    public void speakersSection_IsNotVisible() {
        onView(ViewMatchers.withId(fr.paug.droidcon2015.R.id.session_speakers_block)).check(matches(not(isDisplayed())));
    }

    @Test
    public void tagSection_IsNotVisible() {
        onView(ViewMatchers.withId(fr.paug.droidcon2015.R.id.session_tags_container)).check(matches(not(isDisplayed())));
    }
    ...
    public void feedbackCard_IsVisible() {
        onView(ViewMatchers.withId(fr.paug.droidcon2015.R.id.give_feedback_card)).perform(scrollTo()).check(matches(isDisplayed()));
    }
    ...
    public static class FakeSessionDetailModelKeynote extends SessionDetailModel {
        ...
        public List<Pair<Integer, Intent>> getLinks(){
            ...
            links.add(new Pair<Integer, Intent>(
                    fr.paug.droidcon2015.R.string.session_feedback_submitlink,
                    getFeedbackIntent()
            ));

            links.add(new Pair<Integer, Intent>(
                    fr.paug.droidcon2015.R.string.session_link_youtube,
