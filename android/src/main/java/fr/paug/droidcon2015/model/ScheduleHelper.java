...
import fr.paug.droidcon2015.myschedule.MyScheduleAdapter;
    ...
    protected void addSessions(long start, long end,
        ...
        try {
            cursor = mContext.getContentResolver().query(
                    ScheduleContractHelper.addOverrideAccountName(ScheduleContract.Sessions.CONTENT_MY_SCHEDULE_URI,
