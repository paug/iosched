...
public class PresenterFragmentImpl extends Fragment
    ...
    public void onUserAction(UserActionEnum action, @Nullable Bundle args) {
        ...
        if (isValid) {
            ...
            if (!success) {
                ...
                LogUtils.LOGE(TAG, "Model doesn't implement user action " + action.getId() + ". Have you "
            ...
            LogUtils.LOGE(TAG, "Invalid user action " + action.getId() + ". Have you called "
    ...
    public void registerContentObserverOnUri(Uri uri, final QueryEnum[] queriesToRun) {
        ...
        if (!mContentObservers.containsKey(uri)) {
            ...
            LogUtils.LOGE(TAG, "This presenter is already registered as a content observer for uri " + uri
