...
package fr.paug.droidcon2015.provider;

import fr.paug.droidcon2015.Config;
import fr.paug.droidcon2015.appwidget.ScheduleWidgetProvider;
import fr.paug.droidcon2015.explore.ExploreSessionsActivity;
import fr.paug.droidcon2015.provider.ScheduleContract.Announcements;
import fr.paug.droidcon2015.provider.ScheduleContract.Blocks;
import fr.paug.droidcon2015.provider.ScheduleContract.Feedback;
import fr.paug.droidcon2015.provider.ScheduleContract.HashtagColumns;
import fr.paug.droidcon2015.provider.ScheduleContract.Hashtags;
import fr.paug.droidcon2015.provider.ScheduleContract.MapMarkers;
import fr.paug.droidcon2015.provider.ScheduleContract.MapTiles;
import fr.paug.droidcon2015.provider.ScheduleContract.MyFeedbackSubmitted;
import fr.paug.droidcon2015.provider.ScheduleContract.MySchedule;
import fr.paug.droidcon2015.provider.ScheduleContract.MyScheduleColumns;
import fr.paug.droidcon2015.provider.ScheduleContract.MyViewedVideos;
import fr.paug.droidcon2015.provider.ScheduleContract.Rooms;
import fr.paug.droidcon2015.provider.ScheduleContract.SearchSuggest;
import fr.paug.droidcon2015.provider.ScheduleContract.SearchTopicsSessions;
import fr.paug.droidcon2015.provider.ScheduleContract.Sessions;
import fr.paug.droidcon2015.provider.ScheduleContract.Speakers;
import fr.paug.droidcon2015.provider.ScheduleContract.Tags;
import fr.paug.droidcon2015.provider.ScheduleContract.VideoColumns;
import fr.paug.droidcon2015.provider.ScheduleContract.Videos;
import fr.paug.droidcon2015.provider.ScheduleDatabase.SessionsSearchColumns;
import fr.paug.droidcon2015.provider.ScheduleDatabase.SessionsSpeakers;
import fr.paug.droidcon2015.provider.ScheduleDatabase.Tables;
import fr.paug.droidcon2015.settings.SettingsUtils;
import fr.paug.droidcon2015.sync.SyncHelper;
import fr.paug.droidcon2015.util.AccountUtils;
import fr.paug.droidcon2015.sync.ConferenceDataHandler;
import fr.paug.droidcon2015.util.SelectionBuilder;
...
import fr.paug.droidcon2015.sync.userdata.AbstractUserDataSyncHelper;

import static fr.paug.droidcon2015.util.LogUtils.LOGD;
import static fr.paug.droidcon2015.util.LogUtils.LOGE;
import static fr.paug.droidcon2015.util.LogUtils.LOGV;
