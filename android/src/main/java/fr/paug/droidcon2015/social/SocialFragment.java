...
package fr.paug.droidcon2015.social;
...
public class SocialFragment extends Fragment {
    ...
    private void initViewListeners() {
        ...
        setUpSocialIcons(io15Panel, SocialModel.SocialLinksEnum.GPLUS_IO15, SocialModel.SocialLinksEnum.TWITTER_IO15);
        ...
        socialGplusDevs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                UIUtils.fireSocialIntent(
                        getActivity(),
                        SocialModel.SocialLinksEnum.GPLUS_DEVS.getUri(),
        ...
        socialTwitterDevs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                UIUtils.fireSocialIntent(
                        getActivity(),
                        SocialModel.SocialLinksEnum.TWITTER_DEVS.getUri(),
        ...
        setUpSocialIcons(extendedPanel, SocialModel.SocialLinksEnum.GPLUS_EXTENDED,
                SocialModel.SocialLinksEnum.TWITTER_EXTENDED);
        ...
        if (UIUtils.getCurrentTime(getActivity()) < Config.SHOW_IO15_REQUEST_SOCIAL_PANEL_TIME) {
            ...
            setUpSocialIcons(requestPanel, SocialModel.SocialLinksEnum.GPLUS_REQUEST,
                    SocialModel.SocialLinksEnum.TWITTER_REQUEST);
     ...
     */
    private void setUpSocialIcons(final View panel, final SocialModel.SocialLinksEnum gPlusValue,
                                  final SocialModel.SocialLinksEnum twitterValue) {
