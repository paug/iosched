...
package fr.paug.droidcon2015.ui.widget;
...
public class ScrimInsetsScrollView extends ScrollView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        final TypedArray a = context.obtainStyledAttributes(attrs,
                fr.paug.droidcon2015.R.styleable.ScrimInsetsView, defStyle, 0);
        if (a == null) {
            return;
        }
        mInsetForeground = a.getDrawable(fr.paug.droidcon2015.R.styleable.ScrimInsetsView_appInsetForeground);
        a.recycle();
