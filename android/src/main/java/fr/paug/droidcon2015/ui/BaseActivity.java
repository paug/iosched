...
package fr.paug.droidcon2015.ui;
...
import fr.paug.droidcon2015.AppApplication;
import fr.paug.droidcon2015.BuildConfig;
import fr.paug.droidcon2015.R;
import fr.paug.droidcon2015.about.AboutActivity;
import fr.paug.droidcon2015.debug.DebugActivity;
import fr.paug.droidcon2015.explore.ExploreIOActivity;
import fr.paug.droidcon2015.framework.Model;
import fr.paug.droidcon2015.framework.PresenterFragmentImpl;
...
import fr.paug.droidcon2015.settings.SettingsActivity;
import fr.paug.droidcon2015.settings.SettingsUtils;
import fr.paug.droidcon2015.social.SocialActivity;
import fr.paug.droidcon2015.sync.SyncHelper;
import fr.paug.droidcon2015.ui.widget.MultiSwipeRefreshLayout;
import fr.paug.droidcon2015.ui.widget.NavDrawerItemView;
import fr.paug.droidcon2015.ui.widget.ScrimInsetsScrollView;
import fr.paug.droidcon2015.util.AccountUtils;
import fr.paug.droidcon2015.util.ImageLoader;
import fr.paug.droidcon2015.util.LUtils;
import fr.paug.droidcon2015.util.LoginAndAuthHelper;
import fr.paug.droidcon2015.util.RecentTasksStyler;
import fr.paug.droidcon2015.util.TimeUtils;
import fr.paug.droidcon2015.util.ThrottledContentObserver;
import fr.paug.droidcon2015.util.UIUtils;
import fr.paug.droidcon2015.videolibrary.VideoLibraryActivity;
import fr.paug.droidcon2015.welcome.WelcomeActivity;
...
import static fr.paug.droidcon2015.util.LogUtils.LOGI;
...
public abstract class BaseActivity extends AppCompatActivity implements
    ...
    protected void onResume() {
        ...
        if (!AccountUtils.enforceActiveGoogleAccount(this, SELECT_GOOGLE_ACCOUNT_RESULT)) {
            LogUtils.LOGD(TAG, "EnforceActiveGoogleAccount returned false");
            return;
        }
    ...
    public void onAuthSuccess(String accountName, boolean newlyAuthenticated) {
        ...
        LogUtils.LOGD(TAG, "onAuthSuccess, account " + accountName + ", newlyAuthenticated="
                + newlyAuthenticated);
    ...
    protected void refreshAccountDependantData() {
        ...
        LogUtils.LOGD(TAG, "Refreshing User Data");
    ...
    (PresenterFragmentImpl presenter, Uri uri, QueryEnum[] queries) {
        if (presenter != null) {
            ...
            LogUtils.LOGE(TAG, "You must add the presenter using addPresenterFragment method before " +
