...
public class FeedbackHelper {
    ...
    private static final String TAG = LogUtils.makeLogTag(FeedbackHelper.class);
     ...
     */
    public void saveSessionFeedback(SessionFeedbackModel.SessionFeedbackData data) {
     ...
     */
    public static SessionFeedbackModel.SessionFeedbackData convertDataMapToFeedbackData(DataMap data) {
        try {
            if (data == null){
                LogUtils.LOGE(TAG, "Failed to parse session data, DataMap is null");
                return null;
            }
            String jsonString = data.getString("response");
            if (TextUtils.isEmpty(jsonString)) {
                LogUtils.LOGE(TAG, "Failed to parse session data, empty json string");
                return null;
            }
            ...
            if (jsonArray.length() > 0) {
                ...
                return new SessionFeedbackModel.SessionFeedbackData(sessionId, answers[0], answers[1], answers[2],
                        answers[3], null);
            }
