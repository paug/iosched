...
package fr.paug.droidcon2015.myschedule;

import fr.paug.droidcon2015.Config;
import fr.paug.droidcon2015.R;
import fr.paug.droidcon2015.model.ScheduleHelper;
import fr.paug.droidcon2015.model.ScheduleItem;
...
public class MyScheduleActivity extends BaseActivity implements MyScheduleFragment.Listener {
    ...
    private static final String ARG_CONFERENCE_DAY_INDEX
            = "fr.paug.droidcon2015.ARG_CONFERENCE_DAY_INDEX";
    ...
    public static final String EXTRA_DIALOG_TITLE
            = "fr.paug.droidcon2015.EXTRA_DIALOG_TITLE";
    public static final String EXTRA_DIALOG_MESSAGE
            = "fr.paug.droidcon2015.EXTRA_DIALOG_MESSAGE";
    public static final String EXTRA_DIALOG_YES
            = "fr.paug.droidcon2015.EXTRA_DIALOG_YES";
    public static final String EXTRA_DIALOG_NO
            = "fr.paug.droidcon2015.EXTRA_DIALOG_NO";
    public static final String EXTRA_DIALOG_URL
            = "fr.paug.droidcon2015.EXTRA_DIALOG_URL";
    ...
    static final class UpdateUIRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (activity == null || activity.hasBeenDestroyed()) {
                LogUtils.LOGD(TAG, "Ativity is not valid anymore. Stopping UI Updater");
                return;
            }
