...
import fr.paug.droidcon2015.ui.widget.CollectionViewCallbacks;
...
import static fr.paug.droidcon2015.ui.widget.CollectionView.Inventory;
import static fr.paug.droidcon2015.ui.widget.CollectionView.InventoryGroup;
import static fr.paug.droidcon2015.ui.widget.CollectionView.OnClickListener;
...
public class ExploreSessionsActivity extends BaseActivity
    ...
    public static final String EXTRA_FILTER_TAG =
            "fr.paug.droidcon2015.explore.EXTRA_FILTER_TAG";
    public static final String EXTRA_SHOW_LIVE_STREAM_SESSIONS =
            "fr.paug.droidcon2015.explore.EXTRA_SHOW_LIVE_STREAM_SESSIONS";

    // The saved instance state filters
    private static final String STATE_FILTER_TAGS =
            "fr.paug.droidcon2015.explore.STATE_FILTER_TAGS";
    private static final String STATE_CURRENT_URI =
            "fr.paug.droidcon2015.explore.STATE_CURRENT_URI";

    private static final String SCREEN_LABEL = "ExploreSessions";

    private static final String TAG = LogUtils.makeLogTag(ExploreSessionsActivity.class);
    ...
    private final View.OnClickListener mDrawerItemCheckBoxClickListener =
        ...
        public void onClick(View v) {
            ...
            LogUtils.LOGD(TAG, "Checkbox with tag: " + theTag.getName() + " isChecked => " + isChecked);
            if (isChecked) {
    ...
    private void reloadFragment() {
        ...
        LogUtils.LOGD(TAG, "Reloading fragment with categories " + mTagFilterHolder.getCategoryCount() +
                " uri: " + uri +
