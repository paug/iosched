...
public class ExploreModel implements Model {
    ...
    public static int getTopicSessionLimit(Context context) {
        ...
        if (atVenue) {
            topicSessionLimit = context.getResources().getInteger(fr.paug.droidcon2015.R.integer
    ...
    public static int getThemeSessionLimit(Context context) {
        ...
        if (atVenue) {
            themeSessionLimit = context.getResources().getInteger(fr.paug.droidcon2015.R.integer
                    .explore_topic_theme_onsite_max_item_count);
        } else {
            themeSessionLimit = context.getResources().getInteger(fr.paug.droidcon2015.R.integer
    ...
    private void rewriteKeynoteDetails(SessionData keynoteData) {
        ...
        if (currentTime >= startTime && currentTime < endTime) {
            stringBuilder.append(mContext.getString(fr.paug.droidcon2015.R.string
                    .live_now));
        } else {
