 ...
 */
package fr.paug.droidcon2015.welcome;
...
public class AccountFragment extends WelcomeFragment
    ...
    private static final String TAG = LogUtils.makeLogTag(AccountFragment.class);
    ...
    protected View.OnClickListener getNegativeListener() {
        return new WelcomeFragmentOnClickListener(mActivity) {
            ...
            public void onClick(View v) {
                // Nothing to do here
                LogUtils.LOGD(TAG, "User needs to select an account.");
                doFinish();
            }
        };
    }
    ...
    public void onCheckedChanged(RadioGroup group, int checkedId) {
        ...
        LogUtils.LOGD(TAG, "Checked: " + mSelectedAccount);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mAccounts == null) {
            LogUtils.LOGD(TAG, "No accounts to display.");
            return null;
        }
        ...
        for (Account account : mAccounts) {
            LogUtils.LOGD(TAG, "Account: " + account.name);
