...
package fr.paug.droidcon2015.service;
...
public class SessionAlarmService extends IntentService
    ...
    public static final String ACTION_NOTIFY_SESSION =
            "fr.paug.droidcon2015.action.NOTIFY_SESSION";
    public static final String ACTION_NOTIFY_SESSION_FEEDBACK =
            "fr.paug.droidcon2015.action.NOTIFY_SESSION_FEEDBACK";
    public static final String ACTION_SCHEDULE_FEEDBACK_NOTIFICATION =
            "fr.paug.droidcon2015.action.SCHEDULE_FEEDBACK_NOTIFICATION";
    public static final String ACTION_SCHEDULE_STARRED_BLOCK =
            "fr.paug.droidcon2015.action.SCHEDULE_STARRED_BLOCK";
    public static final String ACTION_SCHEDULE_ALL_STARRED_BLOCKS =
            "fr.paug.droidcon2015.action.SCHEDULE_ALL_STARRED_BLOCKS";
    public static final String EXTRA_SESSION_START =
            "fr.paug.droidcon2015.extra.SESSION_START";
    public static final String EXTRA_SESSION_END =
            "fr.paug.droidcon2015.extra.SESSION_END";
    public static final String EXTRA_SESSION_ALARM_OFFSET =
            "fr.paug.droidcon2015.extra.SESSION_ALARM_OFFSET";
    public static final String EXTRA_SESSION_ID =
            "fr.paug.droidcon2015.extra.SESSION_ID";
    public static final String EXTRA_SESSION_TITLE =
            "fr.paug.droidcon2015.extra.SESSION_TITLE";
    ...
    private void scheduleAlarm(final long sessionStart,
        ...
        notifIntent.setData(
                new Uri.Builder().authority("fr.paug.droidcon2015")
    ...
    private void notifySessionFeedback(boolean debug) {
        ...
        try {
            ...
            String provideFeedbackTicker = res.getString(fr.paug.droidcon2015.R.string.session_feedback_notification_ticker);
            NotificationCompat.Builder notifBuilder = new NotificationCompat.Builder(this)
                    .setColor(getResources().getColor(fr.paug.droidcon2015.R.color.theme_primary))
                    ...
                    .setSmallIcon(fr.paug.droidcon2015.R.drawable.ic_stat_notification)
            ...
            if (needFeedbackIds.size() == 1) {
                ...
                notifBuilder.setContentTitle(
                        getResources().getQuantityString(fr.paug.droidcon2015.R.plurals.session_plurals,
    ...
    private void notifySession(final long sessionStart, final long alarmOffset) {
        ...
        try {
            ...
            if (starredCount == 1) {
                contentText = res.getString(fr.paug.droidcon2015.R.string.session_notification_text_1, minutesLeft);
            } else {
                contentText = res.getQuantityString(fr.paug.droidcon2015.R.plurals.session_notification_text,
                        starredCount - 1,
                        minutesLeft,
                        starredCount - 1);
            }
            ...
            NotificationCompat.Builder notifBuilder = new NotificationCompat.Builder(this)
                    ...
                    .setColor(getResources().getColor(fr.paug.droidcon2015.R.color.theme_primary))
                    .setTicker(res.getQuantityString(fr.paug.droidcon2015.R.plurals.session_notification_ticker,
                            starredCount,
                            starredCount))
                    .setDefaults(Notification.DEFAULT_SOUND | Notification.DEFAULT_VIBRATE)
                    .setLights(
                    ...
                    .setAutoCancel(true);
            if (minutesLeft > 5) {
                notifBuilder.addAction(fr.paug.droidcon2015.R.drawable.ic_alarm_holo_dark,
            ...
            if (starredCount == 1 && starredSessionTitles.size() > 0) {
                ...
                bigContentTitle = res.getQuantityString(fr.paug.droidcon2015.R.plurals.session_notification_title,
                        starredCount,
                        minutesLeft,
                        starredCount);
            }
