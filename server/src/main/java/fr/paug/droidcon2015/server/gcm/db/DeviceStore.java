...
package fr.paug.droidcon2015.server.gcm.db;
...
public class DeviceStore {
    ...
    public static void register(String gcmId, String gcmGroupId) {
        ...
        if (oldDevice == null) {
            ...
            OfyService.ofy().save().entity(newDevice);
        } else {
            ...
            if (!gcmGroupId.equals(oldDevice.getGcmGroupId())) {
                ...
                OfyService.ofy().save().entity(oldDevice);
            }
        }
    }
    ...
    public static void unregister(String gcmId) {
        ...
        OfyService.ofy().delete().entity(device);
    }
    ...
    public static void updateRegistration(String oldGcmId, String newGcmId) {
        ...
        OfyService.ofy().save().entity(newDevice);
        OfyService.ofy().delete().entity(oldDevice);
    }
    ...
    public static Device findDeviceByGcmId(String regId) {
        return OfyService.ofy().load().type(Device.class).id(regId).now();
    }

    public static List<Device> findDevicesByGcmGroupId(String target) {
        return OfyService.ofy().load().type(Device.class).filter("gPlusId", target).list();
    }
}
