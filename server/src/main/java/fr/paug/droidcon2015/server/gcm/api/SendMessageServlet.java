 ...
 */
package fr.paug.droidcon2015.server.gcm.api;

import fr.paug.droidcon2015.server.gcm.AuthHelper;
import fr.paug.droidcon2015.server.gcm.BaseServlet;
import fr.paug.droidcon2015.server.gcm.db.DeviceStore;
import fr.paug.droidcon2015.server.gcm.db.models.Device;
import fr.paug.droidcon2015.server.gcm.device.MessageSender;
...
public class SendMessageServlet extends BaseServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        AuthHelper.AuthInfo authInfo = AuthHelper.processAuthorization(req);
